import math
import test.parse_func as parse
...
class Analytic:
    ...
    def __init__(self, log, this_order_cfg):
        ...
        """
        self.log = log
        self.unchecked, self.checked = parse.parse_order(self.log)
        # self.order = this_order_cfg
        self.index = parse.match_order(self.unchecked, self.checked, this_order_cfg)
